...
function bot_ui_ini() {
    var botui = new BotUI("hello-mumu")
    botui.message.add({
        delay: 800,
        content: "Hi, there👋"
    }).then(function () {
    ...
    var sure = function () {
            ...
            botui.message.add({
                delay: 600,
                content: "![...](https://cdn.jsdelivr.net/gh/mumudadi/cdn@latest/img/botui/triplet.jpg)"
            })
        },
        secondpart = function () {
            botui.message.add({
                ...
                botui.message.add({
                    delay: 1500,
                    content: "每天遇到不懂得知识点会马上查阅相关资料。"
                }).then(function () {
                    botui.message.add({
                        delay: 1200,
                        content: "做好笔记，深刻理解后把自己的总结写到博客里。"
                    }).then(function () {
                        botui.message.add({
                            delay: 1500,
                            content: "主攻 Java 语言和 JavaScript，略懂 Python/HTML/CSS/"
                        }).then(function () {
                            botui.message.add({
                                delay: 1500,
                                content: "喜欢古风音乐，二次元。"
                                ...
                                botui.message.add({
                                    delay: 1800,
                                    content: "喜欢哔哩哔哩，今年要做活跃up主，开启我的创作道路。"
                                }).then(function () {
                                    botui.action.button({
                                        delay: 1100,
                                        action: [{
        ...
        thirdpart = function () {
            botui.message.add({
                delay: 1E3,
                content: "mumu起名来自于英雄联盟阿木木，我最喜欢的英雄~"
            }).then(function () {
                botui.action.button({
                    delay: 1500,
                    action: [{
